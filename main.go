...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "梦梦", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "梦梦·贝莉雅·戴比路克", "小梦", "梦梦酱","茉茉‧贝莉雅‧戴比路克","モモ·ベリア·デビルーク","モモ","梦梦公主","momo",),
